...
--
-- Servidor: localhost
-- Tiempo de generación: 05-06-2014 a las 04:20:15
...
(7, 'Escanner', 1385.00, 'No requiere de conectarse a la electricidad, se alimenta vÃ­a USB', 'escaner-1.png', 1, 1),
(8, 'computadora', 4000.00, 'HP Computadora Hp All-in-One AMD Dual Core E4', 'computadora-1.png', 1, 1),
(9, 'Laptop', 7999.00, 'Vostro 3050\nProcesador Core i3<br>', 'laptop-1.png', 1, 1),
(10, 'SWITCH 5PORT', 85.00, 'switch 5 puertos', 'switch-2.png', 1, 1),
(11, 'router2', 1700.00, 'Navega, trabaja y juega sin cables\r\nEl compacto router Wireless-G Broadband de Linksys combina tres dispositivos en uno - router, switch y punto de acceso. ', 'router-2.png', 1, 1);
